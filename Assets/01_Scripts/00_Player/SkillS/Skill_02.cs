...
// 01_Fist Skill
public class Skill_02 : SkillScript, IBindSkill
{
    ...
    private void FixedUpdate()
    {
        ...
        else
        {
            ...
            {
                PlayerScript.Instance.GetComponent<Rigidbody2D>().velocity = Vector2.up * 20f;
            }
            else if (ActiveSkill == true)
            {
                PlayerScript.Instance.GetComponent<Rigidbody2D>().velocity = PlayerScript.Instance.inputVec * 20f;
            }
